...
def average_data(algorithm="", dataset="", goal="", times=10,test_name = ""):
    test_acc = get_all_results_for_one_algo(algorithm, dataset, goal, times,test_name)
...
def get_all_results_for_one_algo(algorithm="", dataset="", goal="", times=10, test_name = ""):
    test_acc = []
    algorithms_list = [algorithm] * times
    for i in range(times):
        file_name = dataset + "_" + algorithms_list[i] + "_" + goal + "_" + str(i) + "_" + test_name
